			...
			<dl>
				...
				<dd>
					<ol name="steps">
						...
						<li>レストランテーブルのレコードを取得して、レストランクラスのオブジェクトを生成し、レストラン配列とする（list.phpの修正）。</li>
						<li>レストランIDに一致するレストランをレストランテーブルから取得する（list.phpの修正）。</li>
						<li>レストランIDに一致するレビュをレビュテーブルから取得する（detail.phpの修正）。</li>
						<li>レビュの［投稿］ボタンがクリックされると、入力されたレビュ内容をレビュテーブルに追加する（detail.phpの修正）。</li>
						<li>追加された順にレビュを取得して表示する（detail.phpの修正）。</li>
					</ol>
				</dd>
			</dl>
		</div>
